package scenes
{
    ...
    public class FilterScene extends Scene
    {
        ...
        public function FilterScene()
        {
            ...
            mButton = new Button(SiegeDuel.assets.getTexture("button_normal"), "Switch Filter");
            mButton.x = int(SDContext.CenterX - mButton.width / 2);
            mButton.y = 15;
            mButton.addEventListener(Event.TRIGGERED, onButtonTriggered);
            addChild(mButton);
            
            mImage = new Image(SiegeDuel.assets.getTexture("starling_rocket"));
            mImage.x = int(SDContext.CenterX - mImage.width / 2);
            mImage.y = 170;
            addChild(mImage);
