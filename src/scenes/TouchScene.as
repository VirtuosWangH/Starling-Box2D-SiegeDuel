package scenes
{
    ...
    public class TouchScene extends Scene
    {
        public function TouchScene()
        {
            ...
            var sheet:TouchSheet = new TouchSheet(new Image(SiegeDuel.assets.getTexture("starling_sheet")));
            sheet.x = SDContext.CenterX;
            sheet.y = SDContext.CenterY;
            sheet.rotation = deg2rad(90);
            addChild(sheet);
        }
    }
}